...
export default function Medicos() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingId) {
        await medicosAPI.update(editingId, formData)
      } else {
            ...
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => handleDelete(medico.matricula)}
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-slate-600">
                  <span className="font-medium">Domicilio:</span> {medico.domicilio}
                </p>
                <p className="text-slate-600">
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-slate-800">{editingId ? "Editar Médico" : "Nuevo Médico"}</h2>
